            ...
            <div class="featured-slider featured" data-aos="zoom-in">
                ...
                <div class="featured__slide">
                    ...
                    <div class="entry">
                        ...
                        <div class="entry__background" style="background-image:url('<?= base_url() ?>/assets/images/thumbs/featured/featured-beetle.jpg');"></div>
        ...
        <div class="entries">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/lamp-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/lamp-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/lamp-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/tulips-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/tulips-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/tulips-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/music-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/music-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/music-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/watch-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/watch-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/watch-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/wheel-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/wheel-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/wheel-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/guitarist-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/guitarist-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/guitarist-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/jump-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/jump-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/jump-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/flowers-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/flowers-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/flowers-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/woodcraft-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/woodcraft-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/woodcraft-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/fuji-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/fuji-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/fuji-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/beetle-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/beetle-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/beetle-800.jpg 2x" alt="">
                        </a>
                    </div>
            ...
            <article class="col-block">
                ...
                <div class="item-entry" data-aos="zoom-in">
                    <div class="item-entry__thumb">
                        <a href="single-standard.html" class="item-entry__thumb-link">
                            <img src="<?= base_url() ?>/assets/images/thumbs/post/sydney-400.jpg" srcset="<?= base_url() ?>/assets/images/thumbs/post/sydney-400.jpg 1x, <?= base_url() ?>/assets/images/thumbs/post/sydney-800.jpg 2x" alt="">
                        </a>
                    </div>
